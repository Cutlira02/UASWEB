	...
	<!--Import Google Icon Font-->
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
      	<style type="text/css">
	       ...
	       body {
	          background: url(images/1bg.jpg) no-repeat fixed;
			...
			<form method="POST" action="check-login.php">
				<div class="col s12 m12 l6 offset-l3 card-panel z-depth white">
					<div class="card-title center">
						<h5>REGISTER BARANG MASUK KELUAR</h5>
					</div>
					...
					<div class="row">
						<div class="col s12 m12 l12 center">
							<input name="login" type="submit" value="Masuk" class="modal-action modal-close waves-effect waves-light btn blue darken-2">
						</div>
                  	</div>
					...
					<div class="row">
						<div class="col s12 m12 l12 center">
							<hr/>
							<p>Register Barang Masuk Keluar || Copyright - 2019 || ICT - PT. Mercon</p>
						</div>
                  	</div>
