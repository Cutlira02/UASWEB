...
<body>
	<div class="row">
		...
		<header>
			<!--TopNav-->
	        <nav class="row top-nav grey darken-2">
	    		<div class="container">
				...
				<div class="col s12 m12 l9 offset-l3">
					...
					<div class="col s12 m6 l6">
		                <div class="card blue darken-1">
		                    <div class="card-content black-text text-darken-2">
			                    <span class="card-title">Pengguna
		                    ...
		                    <div class="card-action blue lighten-4">
		                    	...
		                    	<a href="user.php" class="black-text text-darken-2">Selengkapnya</a>
		                    </div>
		                </div>
	                </div>
					...
					<div class="col s12 m6 l6">
		                <div class="card blue darken-1">
		                    ...
		                    <div class="card-action blue lighten-4">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="barangmasuk.php" class="black-text text-darken-2">Selengkapnya</a>
		                    </div>
		                </div>
	                </div>
					...
					<div class="col s12 m6 l6">
		                <div class="card blue darken-1">
		                    ...
		                    <div class="card-action blue lighten-4">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="gudang.php" class="black-text text-darken-2">Selengkapnya</a>
		                    </div>
		                </div>
	                </div>
					...
					<div class="col s12 m6 l6">
		                <div class="card blue darken-1">
		                    ...
		                    <div class="card-action blue lighten-4">
		                    	<i class="material-icons left black-text text-darken-2">visibility</i>
		                    	<a href="barangkeluar.php" class="black-text text-darken-2">Selengkapnya</a>
		                    </div>
		                </div>
	                </div>
