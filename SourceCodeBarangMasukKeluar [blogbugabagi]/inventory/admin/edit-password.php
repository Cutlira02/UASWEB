      ...
      <!--TopNav-->
          ...
          <div class="container">
            <div class="col offset-l2 nav-wrapper">
              ...
              <a class="page-title">Ganti Password</a>
            </div>
          </div>
      </nav>
          ...
          <div class="col s12 m12 l12 card-panel z-depth"> <br>
            <table class="highlight">
              ...
              <table>
                <tr>
                  <th>
                    <input type="submit" name="update" value="Edit Password" class="right waves-effect waves-light btn blue darken-2" style="float: left;">
                  </th>
                  <th style="width: 1%;">
